...
const _routes = [
  {
    name: "bajas",
    path: "/bajas",
    component: () => import('./bajas-CcofILtL.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BPt0-D1T.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-BSopc5Ot.mjs')
  },
  {
    name: "miarea",
    path: "/miarea",
    component: () => import('./miarea-C9Ueb8BV.mjs')
  },
  {
    name: "perfil",
    path: "/perfil",
    component: () => import('./perfil-CmRJiQpJ.mjs')
  },
  {
    name: "archivos",
    path: "/archivos",
    component: () => import('./archivos-C_AKrPsH.mjs')
  },
  {
    name: "usuarios",
    path: "/usuarios",
    component: () => import('./usuarios-BFece7G5.mjs')
  },
  {
    name: "traslados",
    path: "/traslados",
    component: () => import('./traslados-Cp8i963n.mjs')
  },
  {
    name: "revisiones",
    path: "/revisiones",
    component: () => import('./revisiones-5gCYCPpz.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CaJ3thE_.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DJn5AGjN.mjs'));
...
export { _export_sfc as _, useRouter as a, useNuxtApp as b, nuxtLinkDefaults as c, entry$1 as default, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRuntimeConfig as u };
